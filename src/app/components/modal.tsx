...
const Modal = () => {
    ...
    return (<div id="default-modal" aria-hidden="true" className="hidden h-screen w-screen overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
